...
public class ExteriorWallInspection_sol {
    ...
    public static void main(String args[]){
        System.out.print(solution(12, new int[] {1,5,6,10}, new int[]{1,2,3,4}));
        System.out.print(solution(12, new int[] {1,3,4,9,10}, new int[]{3,5,7}));
    }
}
